...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> bookItem(long userId, BookingCreateRequest requestDto) {
    ...
    public ResponseEntity<Object> getBookingsByItemsOwner(Long userId, BookingState state) {
        Map<String, Object> parameters = Map.of(
                "state", state.name()
        );
